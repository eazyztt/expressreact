...
async function clarifyWithDeepSeek(text) {
  try {
    const prompt = `${text} Вот все сообщения твои и пользователя. Ты являешься специалистом в области отношений, дай наилучший ответ на последнее сообщение которое тебе пришлет пользователь исходя из истории всего чата и не объясняй свой выбор.`;
